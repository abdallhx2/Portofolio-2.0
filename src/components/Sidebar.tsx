...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-full z-50 transition-all duration-500 ease-out overflow-y-auto shadow-2xl lg:shadow-none border-r ${isMobileMenuOpen
      ...
      >
        <div className="flex flex-col h-full p-2 sm:p-4 lg:p-3 relative">
          ...
          <button
            ...
            className={`sb-collapse-hover hidden lg:flex absolute top-4 z-10 w-7 h-7 rounded-full shadow-lg items-center justify-center transition-all duration-300 hover:scale-110 border ${isSidebarCollapsed ? 'right-1.5' : 'right-2'
              }`}
          ...
          <div className={`mb-3 sm:mb-6 ${isSidebarCollapsed ? 'lg:hidden' : ''}`}>
            <button
              ...
              className="sb-search-hover w-full flex items-center px-3 py-2 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-200 group hover:scale-[1.02] border gap-2 sm:gap-3"
            >
          ...
          {isSidebarCollapsed && (
            <div className="hidden lg:block mb-3">
              <button
                onClick={() => setIsSearchOpen(true)}
                className="sb-search-hover w-full flex justify-center px-1.5 py-2.5 rounded-lg transition-all duration-200 group hover:scale-110 border relative"
              >
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`sb-nav-item ${isActive ? 'sb-nav-active' : ''} flex items-center transition-all duration-200 group relative overflow-hidden hover:scale-[1.02] ${isSidebarCollapsed
          ...
          <div className="mt-3 sm:mt-6">
            ...
            <div className="mb-3 sm:mb-6">
              <div className={`flex items-center gap-1.5 sm:gap-3 ${isSidebarCollapsed ? 'lg:flex-col lg:gap-2' : 'justify-center'}`}>
                ...
                <button
                  onClick={toggleTheme}
                  className={`sb-primary-hover ${isSidebarCollapsed ? 'w-10 h-10 sm:w-11 sm:h-11' : 'w-10 h-10 sm:w-12 sm:h-12'} rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 hover:shadow-lg relative group`}
                >
                ...
                <button
                  ...
                  className={`sb-primary-hover ${isSidebarCollapsed ? 'w-10 h-10 sm:w-11 sm:h-11 text-sm sm:text-base' : 'w-10 h-10 sm:w-12 sm:h-12 text-xs sm:text-sm'} rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 hover:shadow-lg font-bold relative group`}
                >
                ...
                <div className="flex items-center justify-center gap-1.5 sm:gap-3">
                  {personalInfo.socialLinks.github && (
                    <a
                      ...
                      className="sb-primary-hover w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 hover:shadow-lg"
                      title="GitHub"
                    >
