...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      process: {
        ...
        discoveryDesc: 'Understanding your business, target audience, and project goals. I gather insights through research and align on a clear strategy for success.',
        design: 'Ideation & Wireframing',
        designDesc: 'Creating wireframes and prototypes to map out structure and flow, ensuring the user journey is smooth and intuitive.',
        development: 'Design & Development',
        developmentDesc: 'Bringing the product to life through high-fidelity design and development, ensuring every interaction is pixel-perfect and functional.',
        testing: 'Testing & Launch',
        testingDesc: 'Using testing insights to refine the design, ensuring the final product is aesthetically pleasing, effective, and user-centered.',
      },
    },
    about: {
      title: 'Who am I?',
  ...
  ar: {
    ...
    home: {
      ...
      process: {
        title: 'كيف أعمل',
        subtitle: 'منهجيتي في التطوير من الفكرة حتى الإطلاق',
        discovery: 'الاستكشاف والاستراتيجية',
        discoveryDesc: 'فهم طبيعة عملك، جمهورك المستهدف، وأهداف المشروع. أجمع المعلومات من خلال البحث وأضع استراتيجية واضحة للنجاح.',
        design: 'التفكير والنمذجة',
        designDesc: 'إنشاء النماذج الأولية لرسم الهيكل والتدفق، مع ضمان أن تكون رحلة المستخدم سلسة وبديهية.',
        development: 'التصميم والتطوير',
        developmentDesc: 'إحياء المنتج من خلال تصميم عالي الدقة وتطوير متقن، مع ضمان أن كل تفاعل مثالي ووظيفي.',
        testing: 'الاختبار والإطلاق',
        testingDesc: 'استخدام نتائج الاختبار لتحسين التصميم، مع ضمان أن المنتج النهائي جذاب بصرياً وفعال ومتمحور حول المستخدم.',
      },
    },
    about: {
      title: 'من أنا؟',
    ...
    projects: {
      ...
      totalProjects: 'مشروع',
      technologiesUsed: 'تقنية',
      yearsActive: 'سنوات نشاط',
    },
    services: {
      title: 'الخدمات',
